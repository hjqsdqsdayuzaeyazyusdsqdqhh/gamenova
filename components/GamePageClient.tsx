          ...
          {isValid ? (
            ...
            <div className="w-full min-h-[700px] bg-black flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-400 font-semibold">⚠ Game not available in this platform</p>
                <p className="text-gray-600 text-sm mt-1">This game has not passed verification and cannot be played here.</p>
              </div>
            </div>
          )}
